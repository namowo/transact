...
from app.crud.epg_interpretation_method import crud_epg_interpretation_method as crud
from app.schemas.epg_interpretation_method import (
    EPGInterpretationMethodRead as ReadSchema,
    EPGInterpretationMethodCreate as CreateSchema,
    EPGInterpretationMethodUpdate as UpdateSchema,
)
