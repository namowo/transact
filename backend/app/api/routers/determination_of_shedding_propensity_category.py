...
from app.crud.determination_of_shedding_propensity_category import crud_determination_of_shedding_propensity_category as crud
from app.schemas.determination_of_shedding_propensity_category import (
    DeterminationOfSheddingPropensityCategoryRead as ReadSchema,
    DeterminationOfSheddingPropensityCategoryCreate as CreateSchema,
    DeterminationOfSheddingPropensityCategoryUpdate as UpdateSchema,
)
