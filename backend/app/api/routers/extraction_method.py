...
from app.crud.extraction_method import crud_extraction_method as crud
from app.schemas.extraction_method import (
    ExtractionMethodRead as ReadSchema,
    ExtractionMethodCreate as CreateSchema,
    ExtractionMethodUpdate as UpdateSchema,
)
