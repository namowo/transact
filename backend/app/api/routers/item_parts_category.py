...
from app.crud.item_parts_category import crud_item_parts_category as crud
from app.schemas.item_parts_category import (
    ItemPartsCategoryRead as ReadSchema,
    ItemPartsCategoryCreate as CreateSchema,
    ItemPartsCategoryUpdate as UpdateSchema,
)
