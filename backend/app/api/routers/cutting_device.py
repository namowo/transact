...
from app.crud.cutting_device import crud_cutting_device as crud
from app.schemas.cutting_device import (
    CuttingDeviceRead as ReadSchema,
    CuttingDeviceCreate as CreateSchema,
    CuttingDeviceUpdate as UpdateSchema,
)
