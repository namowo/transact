...
from app.crud.wetting_agent import crud_wetting_agent as crud
from app.schemas.wetting_agent import (
    WettingAgentRead as ReadSchema,
    WettingAgentCreate as CreateSchema,
    WettingAgentUpdate as UpdateSchema,
)
