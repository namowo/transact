...
from app.crud.classification_scheme import crud_classification_scheme as crud
from app.schemas.classification_scheme import (
    ClassificationSchemeRead as ReadSchema,
    ClassificationSchemeCreate as CreateSchema,
    ClassificationSchemeUpdate as UpdateSchema,
)
