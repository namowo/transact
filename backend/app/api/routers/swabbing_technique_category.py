...
from app.crud.swabbing_technique_category import crud_swabbing_technique_category as crud
from app.schemas.swabbing_technique_category import (
    SwabbingTechniqueCategoryRead as ReadSchema,
    SwabbingTechniqueCategoryCreate as CreateSchema,
    SwabbingTechniqueCategoryUpdate as UpdateSchema,
)
