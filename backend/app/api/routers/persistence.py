...
from app.crud.persistence import crud_persistence as crud
from app.schemas.persistence import (
    PersistenceRead as ReadSchema,
    PersistenceCreate as CreateSchema,
    PersistenceUpdate as UpdateSchema,
)
