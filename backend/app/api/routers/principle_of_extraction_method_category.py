...
from app.crud.principle_of_extraction_method_category import crud_principle_of_extraction_method_category as crud
from app.schemas.principle_of_extraction_method_category import (
    PrincipleOfExtractionMethodCategoryRead as ReadSchema,
    PrincipleOfExtractionMethodCategoryCreate as CreateSchema,
    PrincipleOfExtractionMethodCategoryUpdate as UpdateSchema,
)
