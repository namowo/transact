...
from app.crud.surface_material_category import crud_surface_material_category as crud
from app.schemas.surface_material_category import (
    SurfaceMaterialCategoryRead as ReadSchema,
    SurfaceMaterialCategoryCreate as CreateSchema,
    SurfaceMaterialCategoryUpdate as UpdateSchema,
)
