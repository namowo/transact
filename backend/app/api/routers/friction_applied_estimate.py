...
from app.crud.friction_applied_estimate import crud_friction_applied_estimate as crud
from app.schemas.friction_applied_estimate import (
    FrictionAppliedEstimateRead as ReadSchema,
    FrictionAppliedEstimateCreate as CreateSchema,
    FrictionAppliedEstimateUpdate as UpdateSchema,
)
