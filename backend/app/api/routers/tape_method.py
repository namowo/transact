...
from app.crud.tape_method import crud_tape_method as crud
from app.schemas.tape_method import (
    TapeMethodRead as ReadSchema,
    TapeMethodCreate as CreateSchema,
    TapeMethodUpdate as UpdateSchema,
)
