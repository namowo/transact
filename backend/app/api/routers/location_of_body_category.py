...
from app.crud.location_of_body_category import crud_location_of_body_category as crud
from app.schemas.location_of_body_category import (
    LocationOfBodyCategoryRead as ReadSchema,
    LocationOfBodyCategoryCreate as CreateSchema,
    LocationOfBodyCategoryUpdate as UpdateSchema,
)
