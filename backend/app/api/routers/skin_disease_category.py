...
from app.crud.skin_disease_category import crud_skin_disease_category as crud
from app.schemas.skin_disease_category import (
    SkinDiseaseCategoryRead as ReadSchema,
    SkinDiseaseCategoryCreate as CreateSchema,
    SkinDiseaseCategoryUpdate as UpdateSchema,
)
