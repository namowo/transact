...
from app.crud.scraping_device import crud_scraping_device as crud
from app.schemas.scraping_device import (
    ScrapingDeviceRead as ReadSchema,
    ScrapingDeviceCreate as CreateSchema,
    ScrapingDeviceUpdate as UpdateSchema,
)
