...
from app.crud.sampling_method import crud_sampling_method as crud
from app.schemas.sampling_method import (
    SamplingMethodRead as ReadSchema,
    SamplingMethodCreate as CreateSchema,
    SamplingMethodUpdate as UpdateSchema,
)
