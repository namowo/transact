...
from app.crud.classification_criteria import crud_classification_criteria as crud
from app.schemas.classification_criteria import (
    ClassificationCriteriaRead as ReadSchema,
    ClassificationCriteriaCreate as CreateSchema,
    ClassificationCriteriaUpdate as UpdateSchema,
)
