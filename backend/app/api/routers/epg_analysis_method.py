...
from app.crud.epg_analysis_method import crud_epg_analysis_method as crud
from app.schemas.epg_analysis_method import (
    EPGAnalysisMethodRead as ReadSchema,
    EPGAnalysisMethodCreate as CreateSchema,
    EPGAnalysisMethodUpdate as UpdateSchema,
)
