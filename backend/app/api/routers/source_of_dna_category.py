...
from app.crud.source_of_dna_category import crud_source_of_dna_category as crud
from app.schemas.source_of_dna_category import (
    SourceOfDNACategoryRead as ReadSchema,
    SourceOfDNACategoryCreate as CreateSchema,
    SourceOfDNACategoryUpdate as UpdateSchema,
)
