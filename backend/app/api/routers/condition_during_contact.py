...
from app.crud.condition_during_contact import crud_condition_during_contact as crud
from app.schemas.condition_during_contact import (
    ConditionDuringContactRead as ReadSchema,
    ConditionDuringContactCreate as CreateSchema,
    ConditionDuringContactUpdate as UpdateSchema,
)
