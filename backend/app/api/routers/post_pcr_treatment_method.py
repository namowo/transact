...
from app.crud.post_pcr_treatment_method import crud_post_pcr_treatment_method as crud
from app.schemas.post_pcr_treatment_method import (
    PostPCRTreatmentMethodRead as ReadSchema,
    PostPCRTreatmentMethodCreate as CreateSchema,
    PostPCRTreatmentMethodUpdate as UpdateSchema,
)
