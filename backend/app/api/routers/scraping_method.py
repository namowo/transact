...
from app.crud.scraping_method import crud_scraping_method as crud
from app.schemas.scraping_method import (
    ScrapingMethodRead as ReadSchema,
    ScrapingMethodCreate as CreateSchema,
    ScrapingMethodUpdate as UpdateSchema,
)
