...
from app.crud.shedder_test import crud_shedder_test as crud
from app.schemas.shedder_test import (
    ShedderTestRead as ReadSchema,
    ShedderTestCreate as CreateSchema,
    ShedderTestUpdate as UpdateSchema,
)
