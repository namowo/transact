...
from app.crud.degradation_category import crud_degradation_category as crud
from app.schemas.degradation_category import (
    DegradationCategoryRead as ReadSchema,
    DegradationCategoryCreate as CreateSchema,
    DegradationCategoryUpdate as UpdateSchema,
)
