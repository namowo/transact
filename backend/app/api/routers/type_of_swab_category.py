...
from app.crud.type_of_swab_category import crud_type_of_swab_category as crud
from app.schemas.type_of_swab_category import (
    TypeOfSwabCategoryRead as ReadSchema,
    TypeOfSwabCategoryCreate as CreateSchema,
    TypeOfSwabCategoryUpdate as UpdateSchema,
)
