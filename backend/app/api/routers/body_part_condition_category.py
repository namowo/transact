...
from app.crud.body_part_condition_category import crud_body_part_condition_category as crud
from app.schemas.body_part_condition_category import (
    BodyPartConditionCategoryRead as ReadSchema,
    BodyPartConditionCategoryCreate as CreateSchema,
    BodyPartConditionCategoryUpdate as UpdateSchema,
)
