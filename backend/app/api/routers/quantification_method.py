...
from app.crud.quantification_method import crud_quantification_method as crud
from app.schemas.quantification_method import (
    QuantificationMethodRead as ReadSchema,
    QuantificationMethodCreate as CreateSchema,
    QuantificationMethodUpdate as UpdateSchema,
)
