...
from app.crud.type_of_tape import crud_type_of_tape as crud
from app.schemas.type_of_tape import (
    TypeOfTapeRead as ReadSchema,
    TypeOfTapeCreate as CreateSchema,
    TypeOfTapeUpdate as UpdateSchema,
)
