...
from app.crud.thermocycler import crud_thermocycler as crud
from app.schemas.thermocycler import (
    ThermocyclerRead as ReadSchema,
    ThermocyclerCreate as CreateSchema,
    ThermocyclerUpdate as UpdateSchema,
)
