...
from app.crud.statistical_software import crud_statistical_software as crud
from app.schemas.statistical_software import (
    StatisticalSoftwareRead as ReadSchema,
    StatisticalSoftwareCreate as CreateSchema,
    StatisticalSoftwareUpdate as UpdateSchema,
)
