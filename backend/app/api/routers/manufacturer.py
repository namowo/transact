...
from app.crud.manufacturer import crud_manufacturer as crud
from app.schemas.manufacturer import (
    ManufacturerRead as ReadSchema,
    ManufacturerCreate as CreateSchema,
    ManufacturerUpdate as UpdateSchema,
)
