...
from app.crud.inhibition_category import crud_inhibition_category as crud
from app.schemas.inhibition_category import (
    InhibitionCategoryRead as ReadSchema,
    InhibitionCategoryCreate as CreateSchema,
    InhibitionCategoryUpdate as UpdateSchema,
)
