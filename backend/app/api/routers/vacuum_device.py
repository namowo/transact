...
from app.crud.vacuum_device import crud_vacuum_device as crud
from app.schemas.vacuum_device import (
    VacuumDeviceRead as ReadSchema,
    VacuumDeviceCreate as CreateSchema,
    VacuumDeviceUpdate as UpdateSchema,
)
