...
from app.crud.dna_shedding_propensity_category import (
    crud_dna_shedding_propensity_category as crud,
)
from app.schemas.dna_shedding_propensity_category import (
    DNASheddingPropensityCategoryRead as ReadSchema,
    DNASheddingPropensityCategoryCreate as CreateSchema,
    DNASheddingPropensityCategoryUpdate as UpdateSchema,
)
