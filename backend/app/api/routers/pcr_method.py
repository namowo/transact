...
from app.crud.pcr_method import crud_pcr_method as crud
from app.schemas.pcr_method import (
    PCRMethodRead as ReadSchema,
    PCRMethodCreate as CreateSchema,
    PCRMethodUpdate as UpdateSchema,
)
