...
from app.crud.condition_of_item_part_category import crud_condition_of_item_part_category as crud
from app.schemas.condition_of_item_part_category import (
    ConditionOfItemPartCategoryRead as ReadSchema,
    ConditionOfItemPartCategoryCreate as CreateSchema,
    ConditionOfItemPartCategoryUpdate as UpdateSchema,
)
