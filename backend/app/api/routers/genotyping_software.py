...
from app.crud.genotyping_software import crud_genotyping_software as crud
from app.schemas.genotyping_software import (
    GenotypingSoftwareRead as ReadSchema,
    GenotypingSoftwareCreate as CreateSchema,
    GenotypingSoftwareUpdate as UpdateSchema,
)
