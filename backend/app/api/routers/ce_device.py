...
from app.crud.ce_device import crud_ce_device as crud
from app.schemas.ce_device import (
    CEDeviceRead as ReadSchema,
    CEDeviceCreate as CreateSchema,
    CEDeviceUpdate as UpdateSchema,
)
