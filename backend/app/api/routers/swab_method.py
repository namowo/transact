...
from app.crud.swab_method import crud_swab_method as crud
from app.schemas.swab_method import (
    SwabMethodRead as ReadSchema,
    SwabMethodCreate as CreateSchema,
    SwabMethodUpdate as UpdateSchema,
)
