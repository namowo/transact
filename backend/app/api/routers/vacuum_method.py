...
from app.crud.vacuum_method import crud_vacuum_method as crud
from app.schemas.vacuum_method import (
    VacuumMethodRead as ReadSchema,
    VacuumMethodCreate as CreateSchema,
    VacuumMethodUpdate as UpdateSchema,
)
